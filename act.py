#crear una clase fabrica que tenga los atributos lantas, color y precio;luego crear dos clases mas que se hereden, las cuales son moto y auto, crear metodos que muestren la cantidad de llantas, precio y que colores
